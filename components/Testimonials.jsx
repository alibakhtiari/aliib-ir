    ...
    <section id="testimonials" className="section bg-gray-900 text-white py-16">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-blue-400 text-lg font-medium mb-2">Testimonials</h2>
          <h3 className="text-3xl md:text-4xl font-bold text-white">What Clients Say</h3>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-16 mb-12">
          ...
          <div className="flex items-center">
            ...
            <span className="font-bold">100+ Projects Completed</span>
          </div>
          <div className="flex items-center">
            ...
            <span className="font-bold">50+ Happy Clients</span>
          </div>
        </div>
