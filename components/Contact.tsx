              ...
              <div className="h-full p-8 bg-white shadow-lg dark:bg-gray-900 rounded-xl">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex items-center justify-center w-10 h-10 mt-1 text-blue-600 bg-blue-100 rounded-full dark:bg-blue-900/30 dark:text-blue-400">
                      <svg
                    ...
                    <div className="ms-4">
                      ...
                      <a href="tel:+989125811880" className="text-gray-600 dark:text-gray-400">+989125811880</a>
                    </div>
                  </div>

                  <div className="flex items-start">
                    <div className="p-3 me-4 bg-blue-100 rounded-full dark:bg-blue-900/30">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
