...
const Contact = () => {
  ...
  return (
    <section id="contact" className={`section bg-gray-50 dark:bg-gray-800 ${isRTL ? "text-right" : "text-left"}`}>
          ...
          <div className="flex flex-col md:flex-row gap-12">
            ...
            <div className="md:w-2/5">
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-lg p-8 h-full">
                <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-6">{t("contact.info")}</h4>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="text-gray-900 dark:text-white font-medium">{t("contact.phone")}</h5>
                      <p className="text-gray-600 dark:text-gray-400">{t("contact.phoneNumber")}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="text-gray-900 dark:text-white font-medium">{t("contact.email")}</h5>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h5 className="text-gray-900 dark:text-white font-medium">{t("contact.location")}</h5>
                      <p className="text-gray-600 dark:text-gray-400">{t("contact.locationAddress")}</p>
                    </div>
                  </div>
                </div>

                <div className="mt-8">
                  <h5 className="text-gray-900 dark:text-white font-medium mb-4">{t("contact.followMe")}</h5>
